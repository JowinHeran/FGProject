 ...
 */
class FGMaterialPAD extends CActiveRecord
{
	/**
	...
	public function getImage($type){
                                      switch($type){
                                          case 1:
                                              return FGMaterialPAD::$base_upload_photo_dir.$this->image;
                                              break;
                                          case 2:
                                              return FGMaterialPAD::$base_upload_photo_v_dir.$this->image_v;
                                              break;
                                           case 3:
                                               return FGMaterialPAD::$base_upload_movie_dir.$this->movie;
                                              break;
                                          default:
                                              return FGMaterialPAD::$base_upload_photo_dir.$this->image;
                                              break;
	...
	public function getImagePath(){
		if($this->image==""){
			...
			return FGMaterialPAD::$base_image_path.$this->image;
		}
	}
		...
		if($this->image_v==""){
			...
			return FGMaterialPAD::$base_image_v_path.$this->image_v;
		}
	}
		...
		if($this->movie==""){
			...
			return FGMaterialPAD::$base_movie_path.$this->movie;
		}
	}
	/**
