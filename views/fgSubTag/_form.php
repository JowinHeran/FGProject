...
$selectItem = $model->getSelectItem();
$tagId = intval(trim($_GET['tag_id']));
// 初始化主標籤
($model->isNewRecord && isset($tagId) && $tagId) ? ($model->tag_id=$tagId):("");
...
<div class="form">
    ...
    <?php echo $form->errorSummary($model); ?>
			...
			<?php echo $form->dropDownListControlGroup($model,'tag_id',$selectItem['tag'],array('empty'=>'請選擇主分類')); ?>
