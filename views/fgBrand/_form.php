...
?>
    ...
    <?php echo $form->errorSummary($model); ?>
            ...
            <?php echo $form->dropDownListControlGroup($model,'advertiser_id',$selectItem['advertiser'],array('empty'=>"請選擇廣告主")); ?>
            ...
            <?php //echo $form->textFieldControlGroup($model,'product',array('span'=>5,'maxlength'=>45)); ?>

            <?php //echo $form->textFieldControlGroup($model,'vat_number',array('span'=>5,'maxlength'=>45)); ?>

            <?php //echo $form->textFieldControlGroup($model,'contract',array('span'=>5,'maxlength'=>45)); ?>

            <?php //echo $form->labelEx($model,'contract_status');?>
            <?php //echo $form->inlineRadioButtonList($model,'contract_status',$model->returnIconData(array(0=>"執行中",1=>"暫停",2=>"中止",3=>"結束")));?>
